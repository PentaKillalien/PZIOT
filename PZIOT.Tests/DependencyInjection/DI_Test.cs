...
using AutoMapper;
using PZIOT.AuthHelper;
using PZIOT.Common;
using PZIOT.Common.AppConfig;
...
using PZIOT.Repository.MongoRepository;
...
namespace PZIOT.Tests
{
    public class DI_Test
    {
        ...
        public IContainer DICollections()
        {
            ...
            var servicesDllFile = Path.Combine(basePath, "PZIOT.Services.dll");
            ...
            var repositoryDllFile = Path.Combine(basePath, "PZIOT.Repository.dll");
